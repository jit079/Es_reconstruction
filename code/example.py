...
sz=30. # solar zenith angle corresponding to the input Ed observation time
...
output_wl=np.arange(315,900,5) # the output wavelengths that you want to reconstruct Ed at
